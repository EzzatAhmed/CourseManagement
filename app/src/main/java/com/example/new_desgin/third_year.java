...
public class third_year extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.third_year);

        CardView first = findViewById(R.id.frst_term_3);
        first.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                download_1st_term_third();

            }
        });

        CardView second = findViewById(R.id.scnd_term_3);
        second.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                download_scnd_term_third();
            }
        });
    ...
    private  void download_1st_term_third()
    {
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFile(third_year.this,"....",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    private  void download_scnd_term_third()
    {
        storageReference= FirebaseStorage.getInstance().getReference();
        ref=storageReference.child("...");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
