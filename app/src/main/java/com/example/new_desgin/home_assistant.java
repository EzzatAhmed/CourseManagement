...
public class home_assistant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView profile = findViewById(R.id.profileid_ass);
        ...
        CardView course = findViewById(R.id.courseid_ass);
        ...
        CardView logout = findViewById(R.id.logoutid_ass);
